...
from model.DeepMicroClass import DeepMicroClass, LightningDMC
import torch
...
model = LightningDMC.load_from_checkpoint('data/pt_logs/checkpoint/epoch=2999-step=768000-val_f1=0.906-val_acc=0.907.ckpt', model=DeepMicroClass(), map_location=device)
model.eval()
model.to(device)
model_cpu = LightningDMC.load_from_checkpoint('data/pt_logs/checkpoint/epoch=2999-step=768000-val_f1=0.906-val_acc=0.907.ckpt', model=DeepMicroClass())
model_cpu.eval()
batch_size = 32
