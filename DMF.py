...
class LightningDMF(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_acc_epoch', accuracy(y_hat, y.int(), average='macro', num_classes=5), on_step=False, on_epoch=True, prog_bar=True)
        self.log('train_f1_epoch', f1_score(y_hat, y.int(), average='macro', num_classes=5), on_step=False, on_epoch=True, prog_bar=True)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_acc', accuracy(y_hat, y.int(), average='macro', num_classes=5), prog_bar=True)
        self.log('val_f1', f1_score(y_hat, y.int(), average='macro', num_classes=5), prog_bar=True)
        return loss
